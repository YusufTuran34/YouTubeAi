INSERT INTO job (name, script_path, script_params, channel, cron_expression, next_script1, next_script2, active, last_log, last_exit_code, sequence) VALUES
  ('Daily 5m Stream', 'sh_scripts/run_pipeline_and_stream.sh', '0.083 --tag lofi --post-twitter --post-instagram', 'default', '0 0 0 * * *', NULL, NULL, true, NULL, NULL, 1),
  ('Daily 5m Upload', 'sh_scripts/run_pipeline_and_upload.sh', '0.083 --tag lofi --post-twitter', 'default', '0 0 15 * * *', NULL, NULL, true, NULL, NULL, 2),
  ('Daily 5m Upload Test', 'sh_scripts/run_pipeline_and_upload.sh', '0.083 --tag lofi --post-twitter', 'default', '0 30 3 * * *', NULL, NULL, true, NULL, NULL, 3),
